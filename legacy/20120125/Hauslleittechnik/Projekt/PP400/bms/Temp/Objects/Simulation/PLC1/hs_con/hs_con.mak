...
$(AS_CPU_PATH)/hs_con/hs_con.o: \
	...
	$(AS_PROJECT_PATH)/Logical/MainStation/HeatingSystem/hs_con/hs_con.var \
	$(AS_PROJECT_PATH)/Logical/Libraries/astime/astime.typ \
	$(AS_PROJECT_PATH)/Logical/MainStation/HeatingSystem/hs_con/hs_con.typ \
	...
	$(AS_PROJECT_PATH)/Logical/Libraries/LoopConR/LoopConR.var \
	$(AS_PROJECT_PATH)/Logical/Libraries/Runtime/runtime.var
	@"$(AS_BIN_PATH)/BR.AS.IecCompiler.exe" "$(AS_PROJECT_PATH)/Logical/MainStation/HeatingSystem/hs_con/hs_con.st" -o "$(AS_CPU_PATH)/hs_con/hs_con.o"  -O "$(AS_CPU_PATH)/hs_con/hs_con.o.opt" -secret "$(AS_PROJECT_PATH)_br.as.ieccompiler.exe"
