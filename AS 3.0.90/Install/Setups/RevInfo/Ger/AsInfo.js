function DisplayRevisionInfos()
{
    ...
    // Search for revision information files (.pdf) in current directory and build a link for each .pdf file
    {
        ...
        for (i in arrFileList)
        {
            ...
            // Check if current file is a valid revision information file or a known bugs file (KB_...):
        ...
        WriteLinks("Bekannte Probleme", arrFileNamesKnownBugs, arrDisplayNamesKnownBugs);
        WriteLinks("Andere Upgrades", arrFileNamesOther, arrDisplayNamesOther);
    }
}
