...
$(AS_CPU_PATH)/statistics/statistics.o: \
	...
	$(AS_PROJECT_PATH)/Logical/MainStation/statistics/statistics.var \
	...
	@"$(AS_BIN_PATH)/BR.AS.IecCompiler.exe" "$(AS_PROJECT_PATH)/Logical/MainStation/statistics/statistics.st" -o "$(AS_CPU_PATH)/statistics/statistics.o"  -O "$(AS_CPU_PATH)/statistics/statistics.o.opt" -secret "$(AS_PROJECT_PATH)_br.as.ieccompiler.exe"
