...
export AS_CONFIGURATION := MainStation
...
ProjectMakeFile:
	...
	@$(AS_GNU_BIN_PATH)/mingw32-make.exe -r -f 'Z:/Hauslleittechnik/Projekt/PP400/bms/Temp/Objects/$(AS_CONFIGURATION)/PP420/#cpu.mak' -k
